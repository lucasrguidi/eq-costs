...
var UserHelper = /** @class */ (function () {
    ...
    UserHelper.prototype.getUserIdByToken = function (req, res) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        jsonwebtoken_1.default.verify(accessToken, auth_config_1.config.secret, function (err, decoded) {
                            if (err) {
                                return res.status(401).json({ error: 'Token expirado ou inválido' });
                            }
                            if (decoded && typeof decoded === 'object' && 'key' in decoded) {
                                var userId = decoded.key;
                                resolve(userId);
                            }
                            else {
