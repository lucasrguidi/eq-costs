...
var UsersRepository = /** @class */ (function () {
    ...
    UsersRepository.prototype.create = function (username, email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var hashedPassword, user, newUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.prisma.users.create({ data: user })];
                    case 2:
                        newUser = _a.sent();
    ...
    UsersRepository.prototype.update = function (id, _a) {
    ...
    UsersRepository.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prisma.users.update({
                            where: {
                                id: id,
                            },
                            data: {
